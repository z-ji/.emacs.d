...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (multi-term imenu-anywhere highlight-parentheses moe-theme powerline editorconfig expand-region ox-latex-chinese org json-mode ox-twbs company dash magit))))
(custom-set-faces
