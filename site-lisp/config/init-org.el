...
(setq org-todo-keywords
      '((sequence "TODO(t)" "QUESTION(q)" "TASK(T)" "|" "DONE(d)" "UPDATED" "REVIEWED(r)" "KONWLEDGE(k)" "NOTE(n)" "FINISHED(f)" "有点高超(g)")
...
(setq org-html-preamble-format '(("en" "<a class=\"a_1\" href=\"\\\">首页</a>")))
